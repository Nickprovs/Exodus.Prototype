...
namespace Exodus.WpfClient
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private async void ConnectAsync()
        {
            ...
            HubProxy.On<Source>("SourceAdded", source => this.OnSourceAdded(source));
        ...
        private void DefineNewSource_Click(object sender, RoutedEventArgs e)
        {
            string name = this.NewSourceName.Text;
            string hexColor = this.NewSourceColor.SelectedColor.Value.ToString();

            int defaultWidth = 100;
            int.TryParse(this.NewSourceDefaultWidth.Text, out defaultWidth);

            int defaultHeight = 100;
            int.TryParse(this.NewSourceDefaultWidth.Text, out defaultHeight);
            ...
            HubProxy.Invoke("AddSource", newSource);

            this.NewSourceName.Text = string.Empty;
            this.NewSourceName.Focus();
            this.NewSourceDefaultWidth.Text = string.Empty;
            this.NewSourceDefaultHeight.Text = string.Empty;
        }

        private void OnSourceAdded(Source source)
        {
