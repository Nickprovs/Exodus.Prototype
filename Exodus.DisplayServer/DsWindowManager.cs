...
namespace Exodus.DisplayServer
{
    public class DsWindowManager : IDsWindowManager
    {
        #region Fields
        ...
        public DsWindowManager(IRegionManager regionManager, IUnityContainer container)
        {
